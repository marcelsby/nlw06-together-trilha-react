...
import { isEmptyString } from '../services/validations/isEmptyString';
import { userIsLogged } from '../services/validations/userIsLogged';
...
export function Room() {
    ...
    async function handleSendQuestion(event: FormEvent) {
        ...
        if (isEmptyString(newQuestion, 'O campo de pergunta não pode estar vazio!')) {
            return;
        }

        userIsLogged(user, 'Você precisa estar logado para enviar uma pergunta.');
